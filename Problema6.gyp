...
Se hotărăşte ca, dacă ultima notă este cel puţin 8, să le spună părinţilor toate notele primite iar dacă este mai mică decât 8, să le comunice doar cea mai mare notă dintre primele două. 
...
if a<=10 and a>0 and b<=10 &nd b>0 and c<=10 and c>0:
    if c>=8:
        print(a,b,c, sep=" ")
    elif a>b:
        print(a)
        ...
        print(b)
else: print("Error:Notele nu sunt corecte")